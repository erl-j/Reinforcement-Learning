...
###############################################################################
    ...
    def plot_data(self, episodes, scores, max_q_mean):
        label="eps={}, dscf={}, lr={}, ms={}, uf={}, hn={}, hl={}".format(EPISODES,self.discount_factor,self.learning_rate,self.memory_size,self.target_update_frequency,self.hidden_nodes,self.hidden_layers)
        
        pylab.figure(0)
        pylab.title("avg. Q value for {}".format(label))
        pylab.plot(episodes, max_q_mean, 'b')
        pylab.xlabel("Episodes")
        pylab.ylabel("Average Q Value")
        pylab.savefig("qvalues {}.png".format(label))

        pylab.figure(1)
        pylab.title("scores for {}".format(label))
        pylab.plot(episodes, scores, 'b')
        pylab.xlabel("Episodes")
        pylab.ylabel("Score")
        pylab.savefig("scores {}.png".format(label))
